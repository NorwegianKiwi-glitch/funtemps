...
func formatOutput(input float64) string {
	...
	formatted := strconv.FormatFloat(input, 'f', 2, 64)                  // Convert float64 to string and round
	trimmed := strings.TrimRight(strings.TrimRight(formatted, "0"), ".") // Trim trailing zeroes
